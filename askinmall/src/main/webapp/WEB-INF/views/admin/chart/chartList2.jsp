     ...
     <div class="row">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                	<td>
                		<div id="monthlySalesChart"></div> <!-- 차트 출력 위치 -->
                	</td>
                </tr>              
              </tbody></table>
            </div>
...
<!--Load the AJAX API-->
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var chart = new google.visualization.BarChart(document.getElementById('monthlySalesChart')); // firstCategoryChart: chart가 출력되는 위치
